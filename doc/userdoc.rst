...
1. To check that *DiffBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch snowplow_motor_controller view_robot.launch.py
...
6. Let's introspect the ros2_control hardware component. Calling
  ...
  .. code-block:: shell
    ...
    Hardware Component 1
            name: DiffBot
            type: system
            plugin name: snowplow_motor_controller/DiffBotSystemHardware
  ...
  .. code-block:: shell
    ...
    ros2 launch snowplow_motor_controller diffbot.launch.py use_mock_hardware:=True
